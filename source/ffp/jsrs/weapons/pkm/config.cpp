...
class CfgWeapons 
{
    ...
    {
        drysound[] = {"\jsrs_soundmod\jsrs_soundmod_snd_weapons\sounds\dry\m200_dry.ogg", 1.5, 1, 15};
        reloadmagazinesound[] = {"\jsrs_soundmod\jsrs_soundmod_snd_weapons\sounds\reload\m200_reload.ogg", 2, 1, 35};
        ...
        class manual: Mode_FullAuto
        {
            ...
            {
                soundSetShot[] = {"jsrs_rifle_shake_soundset", "jsrs_pkm_shot_soundset", "jsrs_6x5mm_reflector_1", "jsrs_mg_echo_soundset"};
            };
