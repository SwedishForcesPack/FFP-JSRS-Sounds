...
class CfgWeapons 
{
    ...
    class ffp_rk95_base : Rifle_Base_F 
    {
        ...
        class Single: Mode_SemiAuto
        {
            ...
            {
                soundSetShot[] = {"jsrs_rifle_shake_soundset", "jsrs_akm_shot_soundset", "jsrs_akm_shell_soundset", "jsrs_7x62mm_reflector_1", "jsrs_762mm_echo_soundset"};
            };
            class SilencedSound: BaseSoundModeType
            {
                soundSetShot[] = {"jsrs_rifle_shake_soundset", "jsrs_ak12_shot_silenced_soundset", "jsrs_ak12_shell_soundset", "jsrs_7x62mm_sd_reflector_1"};
            };
        };
